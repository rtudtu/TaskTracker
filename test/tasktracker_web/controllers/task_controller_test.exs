defmodule TasktrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{desc: "some desc", name: "some name", status: "some status", time: 42}
  @update_attrs %{desc: "some updated desc", name: "some updated name", status: "some updated status", time: 43}
